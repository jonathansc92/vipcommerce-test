...
use App\Repositories\PedidosProdutosRepository;
use App\Validators\PedidosProdutosValidator;
...
class PedidosProdutosService
{
    private $respository;
    private $validator;

    public function __construct(PedidosProdutosRepository $respository, PedidosProdutosValidator $validator)
    {
